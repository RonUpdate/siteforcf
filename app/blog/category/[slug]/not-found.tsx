...
export default function CategoryNotFound() {
  return (
    <div className="container mx-auto px-4 py-16 flex flex-col items-center justify-center text-center">
      ...
      <p className="text-gray-600 mb-6 max-w-md">Запрашиваемая категория не существует или была удалена.</p>
      <div className="flex flex-col sm:flex-row gap-4">
        <Link href="/blog" className="px-6 py-3 bg-gray-800 text-white rounded-md hover:bg-gray-700 transition-colors">
          Вернуться к блогу
        </Link>
